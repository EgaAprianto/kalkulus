                ...
                <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-tl-lg rounded-bl-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="gap-4 flex flex-wrap">
                            ...
                            <button onClick={simpanData} class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-500 rounded-lg hover:bg-green -800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                    <img 
                                    src={diskette}
                                    className="h-[24px] w-[24px]"
                                    alt="save"/>
                ...
                <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                    <div class="max-w-lg p-6 bg-white border border-gray-200 rounded-tr-lg rounded-br-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="mb-6 flex">
                            ...
                            <p className=''>{i1}{j1}{k1}{i2}{j2}{k2}</p>
                        </div>
